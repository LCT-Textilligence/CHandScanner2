...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"1d8b1879-a488-45b0-b8c9-1911487d44df\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [8 x i8] c"UHF.UHF\00", align 1
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i8* getelementptr inbounds ([8 x i8], [8 x i8]* @__ApplicationConfig_android_package_name.0, i32 0, i32 0); android_package_name
}, align 8

@__DSOCacheEntry_name.1 = internal constant [23 x i8] c"libIDFingerprintAlg.so\00", align 16
@__DSOCacheEntry_name.2 = internal constant [17 x i8] c"libDeviceAPIM.so\00", align 16
...
@__DSOCacheEntry_name.6 = internal constant [17 x i8] c"libDeviceAPIQ.so\00", align 16
